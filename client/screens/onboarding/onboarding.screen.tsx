  ...
  return (
    ...
    >
      <View style={styles.firstContainer}>
        <View>
          <Image source={require("@/assets/CrimeRadar.png")} style={styles.logo} />
        ...
        <View>
          ...
          />
          <Text style={[styles.titleText,{color:"red"},{marginTop:-6}, { fontFamily: "Raleway_700Bold" }]}>
            Crime Radar
          </Text>
        </View>
        <View style={styles.dscpWrapper}>
          <Text style={[styles.dscpText, { fontFamily: "Nunito_400Regular" }]}>
            Explore a variety of features such as
          </Text>
          <Text style={[styles.dscpText, { fontFamily: "Nunito_400Regular" }]}>
            Notice Section, Article Section, Live Criminal Activity Map & More.
          </Text>
        </View>
        <TouchableOpacity
